...
x7-Linux-Debug.commands = $$build  -project="\"$$gameProjectFile\"" x7 Linux Debug $$args
x7-Linux-DebugGame.commands = $$build  -project="\"$$gameProjectFile\"" x7 Linux DebugGame $$args
x7-Linux-Shipping.commands = $$build  -project="\"$$gameProjectFile\"" x7 Linux Shipping $$args
x7-Linux-Test.commands = $$build  -project="\"$$gameProjectFile\"" x7 Linux Test $$args
x7.commands = $$build  -project="\"$$gameProjectFile\"" x7 Linux Development $$args

x7Editor-Linux-Debug.commands = $$build  -project="\"$$gameProjectFile\"" x7Editor Linux Debug $$args
x7Editor-Linux-DebugGame.commands = $$build  -project="\"$$gameProjectFile\"" x7Editor Linux DebugGame $$args
x7Editor-Linux-Shipping.commands = $$build  -project="\"$$gameProjectFile\"" x7Editor Linux Shipping $$args
x7Editor-Linux-Test.commands = $$build  -project="\"$$gameProjectFile\"" x7Editor Linux Test $$args
x7Editor.commands = $$build  -project="\"$$gameProjectFile\"" x7Editor Linux Development $$args
