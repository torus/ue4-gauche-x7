...
UnrealSync-Linux-Debug:
	 $(BUILD) UnrealSync Linux Debug  $(ARGS)

UnrealSync-Linux-DebugGame:
	 $(BUILD) UnrealSync Linux DebugGame  $(ARGS)

UnrealSync-Linux-Shipping:
	 $(BUILD) UnrealSync Linux Shipping  $(ARGS)

UnrealSync-Linux-Test:
	 $(BUILD) UnrealSync Linux Test  $(ARGS)

UnrealSync:
	 $(BUILD) UnrealSync Linux Development  $(ARGS)
...
x7-Linux-Debug:
	 $(PROJECTBUILD) x7 Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

x7-Linux-DebugGame:
	 $(PROJECTBUILD) x7 Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

x7-Linux-Shipping:
	 $(PROJECTBUILD) x7 Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

x7-Linux-Test:
	 $(PROJECTBUILD) x7 Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

x7:
	 $(PROJECTBUILD) x7 Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

x7Editor-Linux-Debug:
	 $(PROJECTBUILD) x7Editor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

x7Editor-Linux-DebugGame:
	 $(PROJECTBUILD) x7Editor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

x7Editor-Linux-Shipping:
	 $(PROJECTBUILD) x7Editor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

x7Editor-Linux-Test:
	 $(PROJECTBUILD) x7Editor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

x7Editor:
	 $(PROJECTBUILD) x7Editor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)
